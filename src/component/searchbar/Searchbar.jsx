...
// <div className=" b w-screen flex justify-end p-4">
//     <form className="max-w-[480px] w-full px-4">
//         <div className="relative">
//             <input type="text" name="q" className="w-full border h-12 shadow p-4 rounded-full" placeholder="search" onChange={searchbar}/>
//             <button type="submit">
